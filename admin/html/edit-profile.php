...
if (isset($_POST["submit"])) {
    ...
    $sql = "UPDATE users2 set usersId=$id, usersName='$name', usersEmail='$email', usersUid='$username' where usersId=$id" ;
                        ...
                        <div class="card">
                            ...
                            <form class="form-horizontal form-material mx-2" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" name="pwdrepeat" class="form-control form-control-line">
                                        </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Username</label>
                                        <div class="col-md-12">
                                            <input type="text" name="uid" value="" class="form-control form-control-line">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success text-white" type="submit" name="submit">Update Profile</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
