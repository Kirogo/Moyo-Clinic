            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="text-center p-20 upgrade-btn">
                            <a href="" class="btn d-block w-100 text-white" target=""></a>
                        </li>
                        <li class="text-center p-20 upgrade-btn">
                            <a href="add-disease.php" class="btn d-block w-100 btn-success text-white">Add Disease
                                Category</a>
                        </li>
                    </ul>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-6">
                        <div class="text-end upgrade-btn">
                            <a href="" class="btn btn-success text-white">Diseases</a>
                        </div>
                    </div>
                </div>
            </div>
