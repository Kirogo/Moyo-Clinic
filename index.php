...
<head>
    ...
    <!-- Google fonts-->
    <link href="https://gitfonts.googleapis.com/css?family=Varela+Round" rel="stylesheet" />
        ...
        <div class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div class="text-center">
                    <h1 class="mx-auto my-0 text-uppercase">MOYO CLINIC</h1>
                    <h2 class="text-white-50 mx-auto mt-2 mb-5">
                        A one place stop to get heart disease diagnosis and consultation
